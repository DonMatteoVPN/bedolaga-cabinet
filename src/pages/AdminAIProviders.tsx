    ...
    <div className="card overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-dark-500">
              {provider.keys_count} 🔑 ·{' '}
              {t('admin.aiProviders.priority', { priority: provider.priority })}
      ...
      {isExpanded && (
        <div className="space-y-4 border-t border-dark-800 p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                provider.enabled ? 'bg-emerald-500' : 'bg-dark-700'
              }`}
            >
              <span
          ...
          {/* Priority */}
          <div className="flex items-center justify-between">
            <span className="text-sm text-dark-300">Приоритет</span>
            <div className="flex items-center gap-2">
              <button
                  ...
                  {(testResult?.models || provider.available_models).map((model) => (
                    <button
                      ...
                      className={`w-full rounded-lg px-3 py-1.5 text-left text-xs transition-colors ${
                        (selectedModel || provider.selected_model) === model
